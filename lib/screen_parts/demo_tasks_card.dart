...
class DemoTasksCard extends StatefulWidget {
  const DemoTasksCard({super.key});

  @override
  State<DemoTasksCard> createState() => _DemoTasksCardState();
}
...
class _DemoTasksCardState extends State<DemoTasksCard> {
  List<Task> tasks = [];
